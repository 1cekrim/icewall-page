...
const Nav = () => {
  ...
  const map_function = (link, _) => {
    return (
    <li className={'nav-item mx-2 my-3' + (link.to === activedLink ? ' active' : '')} onClick={() => onClickLink(link.to)}>
  ...
  return (
    <nav className="navbar navbar-expand-lg fixed-top justify-content-center navbar-dark navbar-fixed-top">
        <ul className="navbar-nav my-3">
          ...
          <Link to="/" className="navbar-brand mx-5" onClick={() => onClickLink('/')}>
            <div>ICEWALL</div>
          </Link>
  ...
  return (
    <div className="App">
      <BrowserRouter>
        <header>
          <section id="top">
            <div id="bg_grid" style={{display: 'inner-block', height: '100%'}}></div>
            ...
            <Nav/>
            <img src={public_folder("/static/img/backgroud/index/background_index_1.png")} className="top-backgroud-image ."></img>
          </section>
        </header>
        <main>
          <Switch>
        ...
        <footer id='footer'>
          <img src={public_folder("/static/img/logo/icewall/icewall.svg")} alt="icewall-logo" width="226.9" height="48.63"/>
          <div id="social">
            ...
            <a href="https://www.youtube.com/channel/UCaVXnXoRT2y-8PcGXlt70Jg">YOUTUBE</a>
          </div>
          <div id="icon">
              <a href="mailto:icewall.executive@gmail.com"><i class="fas fa-envelope"></i></a>
              <a href="https://www.facebook.com/icewall.hyu/"><i class="fab fa-facebook-f"></i></a>
              <a href="https://m.me/icewall.hyu"><i class="fab fa-facebook-messenger"></i></a>
              <a href="https://github.com/HYU-ICEWALL"><i class="fab fa-github"></i></a>
              <a href="https://www.youtube.com/channel/UCaVXnXoRT2y-8PcGXlt70Jg"><i class="fab fa-youtube"></i></a>
          </div>
          <hr />
          <p id="copyright">COPYRIGHT © 2020 Hanyang University Student CERT, ICEWALL. All rights reserved. ||
              <strong>
                  <a href="#">개인정보처리방침</a>
              </strong>
          </p>
